    ...
    <main className="min-h-screen bg-gradient-to-b from-[#ABD6B3] via-[#ABD6B3] to-[#ABD6B3] text-white overflow-x-hidden relative">
      ...
      <div className="relative z-10">
        ...
        <div className="fixed top-0 left-1/2 transform -translate-x-1/2 z-40 w-full max-w-3xl px-4">
          <div className="bg-gradient-to-r from-amber-500/20 via-purple-600/30 to-amber-500/20 backdrop-blur-sm border border-amber-400/30 rounded-lg p-3 shadow-lg mt-3 hover:shadow-amber-500/30 transition-all duration-300 group hover:scale-[1.02] relative overflow-hidden">
            <div className="absolute inset-0 bg-gradient-to-r from-amber-500/0 via-amber-400/20 to-amber-500/0 animate-shimmer-gold"></div>
            ...
            <div className="flex items-center justify-between gap-3 relative">
              <div className="flex items-center gap-2.5">
                ...
                <div className="transform transition-all duration-300 group-hover:translate-x-1">
                  <h3 className="text-xs font-medium bg-gradient-to-r from-amber-200 to-purple-200 bg-clip-text text-transparent group-hover:from-amber-100 group-hover:to-purple-100">
                    Next-Gen NFT Collection Ready!
                  </h3>
                  <p className="text-xs text-amber-200/80 group-hover:text-amber-100/90">Experience your digital assets in a whole new way</p>
                </div>
              </div>
              <a
                href="/nft/mint"
